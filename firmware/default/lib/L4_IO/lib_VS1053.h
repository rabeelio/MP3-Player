...
typedef struct 
{
	LIB_VS1053_SCI_1_SS_REFERENCE_SEL 	: 1; 	// Reference voltage slection, '0' = 1.23V, '1' = 1.65V
	LIB_VS1053_SCI_1_SS_AD_CLOCK 		: 1;	// AD clock select, '0' = 6 MHz, '1' = 3 MHz
	LIB_VS1053_SCI_1_SS_APDOWN1 		: 1;	// Analog internal powerdown
	LIB_VS1053_SCI_1_SS_APDOWN2 		: 1;	// Analog driver powerdown	
	LIB_VS1053_SCI_1_SS_VERSION		 	: 4;	// Version
	LIB_VS1053_SCI_1_SS_RESERVED 		: 2;	// RESERVED
	LIB_VS1053_SCI_1_SS_VCM_DISABLE 	: 1;	// GBUF overload detection '1' = disable
	LIB_VS1053_SCI_1_SS_VCM_OVERLOAD	: 1;	// GBUF overload indicator '1' = overload
	LIB_VS1053_SCI_1_SS_SWING_BIT12 	: 3;	// Set swing to +0dB, +0.5dB, .., or +3.5dB
	LIB_VS1053_SCI_1_SS_DO_NOT_JUMP 	: 1; 	// Header in decode, do not fast forward/rewind
...
typedef struct 
{
	LIB_VS1053_SCI_2_SB_FREQLIMIT	: 4; 	// Bass lower limit frequency in 10 Hz steps (2..15)	
	LIB_VS1053_SCI_2_SB_AMPLITUDE 	: 4;	// Bass enhancement in 1dB steps (0..15, 0 = off)
	LIB_VS1053_SCI_2_ST_FREQLIMIT	: 4;	// Treble lower limit frequency in 1000 Hz steps (1..15)
	LIB_VS1053_SCI_2_ST_AMPLITUDE	: 4;	// Treble control in 1.5 dB steps (-8..7, 0 = off)
...
typedef struct 
{
	LIB_VS1053_SCI_3_SC_FREQ : 11;	// Clock frequency
	LIB_VS1053_SCI_3_SC_ADD	 : 2;	// Allowed multiplier addition
	LIB_VS1053_SCI_3_SC_MULT : 3;	// Clock multiplier 
...
typedef struct 
{
	LIB_VS1053_SCI_8_HDAT0_EMPHASIS		: 2; // See pg. 45
	LIB_VS1053_SCI_8_HDAT0_ORIGINAL		: 1; // See pg. 45
	LIB_VS1053_SCI_8_HDAT0_COPYRIGHT	: 1; // See pg. 45
	LIB_VS1053_SCI_8_HDAT0_EXTENSION	: 2; // See pg. 45	 
	LIB_VS1053_SCI_8_HDAT0_MODE			: 2; // See pg. 45	
	LIB_VS1053_SCI_8_HDAT0_PRIVATE_BIT	: 1; // See pg. 45	
	LIB_VS1053_SCI_8_HDAT0_PAD_BIT		: 1; // See pg. 45	
	LIB_VS1053_SCI_8_HDAT0_SAMPLE_RATE	: 2; // See pg. 45	
	LIB_VS1053_SCI_8_HDAT0_BIT_RATE		: 4; // See pg. 45	
...
typedef struct 
{
	LIB_VS1053_SCI_8_HDAT1_PROTECT_BIT	: 1;  // See pg. 45
	LIB_VS1053_SCI_8_HDAT1_LAYER		: 2;  // See pg. 45
	LIB_VS1053_SCI_8_HDAT1_ID			: 2;  // See pg. 45
	LIB_VS1053_SCI_8_HDAT1_SYNCWORD		: 11; // See pg. 45	 
